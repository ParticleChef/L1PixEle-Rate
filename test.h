...
*/
   fChain->SetBranchAddress("fRecHitN", &fHitN, &b_fHitN);
   fChain->SetBranchAddress("fRecHitGx", &fHitGx, &b_fHitGx);
   fChain->SetBranchAddress("fRecHitGy", &fHitGy, &b_fHitGy);
   fChain->SetBranchAddress("fRecHitGz", &fHitGz, &b_fHitGz);
   fChain->SetBranchAddress("fRhSize", &fClSize, &b_fClSize);
   fChain->SetBranchAddress("fRhSizeX", &fClSizeX, &b_fClSizeX);
   fChain->SetBranchAddress("fRhSizeY", &fClSizeY, &b_fClSizeY);
   fChain->SetBranchAddress("bRecHitN", &bHitN, &b_bHitN);
   fChain->SetBranchAddress("bRecHitGx", &bHitGx, &b_bHitGx);
   fChain->SetBranchAddress("bRecHitGy", &bHitGy, &b_bHitGy);
   fChain->SetBranchAddress("bRecHitGz", &bHitGz, &b_bHitGz);
   fChain->SetBranchAddress("bRhSize", &bClSize, &b_bClSize);
   fChain->SetBranchAddress("bRhSizeX", &bClSizeX, &b_bClSizeX);
   fChain->SetBranchAddress("bRhSizeY", &bClSizeY, &b_bClSizeY);
...
/*
      if(region==5){
      pixel_pixel_deta_upper_width = 0.15;
      pixel_pixel_deta_lower_width = 0.15;
      }
*/
